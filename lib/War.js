...
War.prototype.possibleOutcome = function () {
...
War.prototype.evaluateOutcome = function () {
  if (this.table[0].rawValue > this.table[1].rawValue) {
...
War.prototype.gameOver = function (){
  if (this.playerOneDeck.length === 52 ||  this.playerTwoDeck.length === 52)
  return "Game Over"
}
